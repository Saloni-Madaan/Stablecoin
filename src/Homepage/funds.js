      ...
      <Container className={classes.root}>
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableRow  sx={{'borderTop': 0 , 'borderRight': 0, 'borderBottom': 0, 'borderColor': '#232328','borderLeftWidth': "12px",'borderBottomWidth':"20px",'borderBottomColor':"#F2F0F4",borderStyle:"solid"}}>
            <TableCell style={{ marginLeft: 1000 }}>
                    <h2 style={{ font: "10" }, { color: "#146BAB" }}>View all investments  </h2>
                   
                  </TableCell>
                  <TableCell ><b style={{fontSize:20,color:"white"}}>Investments + total cash & coins</b>
                    </TableCell>
                  ...
                  <TableCell>
                    ...
                    }}><Link  style={{ textDecoration: 'none' }} to={{pathname:"dashboard/transactions"}}><ArrowForwardIosIcon fontSize="large" color="primary"/></Link>  </h3>
                  </TableCell>
         </TableRow>
            </TableHead>
            <TableBody justify="center" className={classes.td}>
              {data.map((curElem, index) => (
                ...
                <TableRow key={index}   sx={{'borderTop': 0 , 'borderRight': 0, 'borderBottom': 0, 'borderColor': '#40BEEA','borderLeftWidth': "12px",'borderBottomWidth':"30px",'borderBottomColor':"#F2F0F4",borderStyle:"solid"}}>
                  ...
                  <TableCell style={{ marginLeft: 1000 }}>
                    ...
                    <h2 style={{ font: "10" }, { color: "#146BAB" }}>  {curElem.name} </h2>
                    AN123456789
                  </TableCell>
